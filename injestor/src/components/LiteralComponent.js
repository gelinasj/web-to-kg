...
class LiteralComponent extends React.Component {
    ...
    render() {
        ...
        return (
            <span id={`Literal-${id}`} className="SubgraphLiteral" style={style} draggable={true} onDragStart={this.onDragStart}>
                <p>Subgraph Literal</p>
            </span>
        );
    }
}
